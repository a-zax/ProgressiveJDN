...
function VoiceToText({ visible, setVisible, setSearch }) {
	...
	async function stopRecording() {
		try {
			...
			flashMessage("Could not stop recording", "danger");
		}
	}
	...
	async function uploadAudio(uri) {
		try {
			...
			try {
				...
				console.error("Error parsing response:", err, res);
				flashMessage("Invalid server response", "danger");
			}
		} catch (err) {
			console.error("Upload failed:", err);
			flashMessage("Failed to upload audio", "danger");
		}
	}
