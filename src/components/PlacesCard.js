...
const styles = StyleSheet.create({
		resultItemContainer: {
			...
			alignItems: "center",
			width: Dimensions.get("window").width / 1.8, // Reduced width to make the card smaller
		...
		name: {
			...
			width: Dimensions.get("window").width / 3, // Reduced width to fit text
		},
		branch: {
		...
		directionButton: {
			...
			borderRadius: 25, // Adjusted radius for a smaller button
			flexDirection: "row",
		...
		resultItemImage: {
			...
			borderRadius: 10, // Reduced border radius for smaller image
		},
		button: {
			paddingVertical: 6, // Reduced padding
			...
			width: 140, // Reduced button width
			zIndex: 10,
			backgroundColor: "#FFFFFF",
		},
	});
